...
- [Live Demo Link](https://cindykandie.github.io/awesome-books/)
...
```sh
  cd my-folder
  git clone git@github.com/cindykandie/awesome-books/.git
```
--->
...
- to install locally run git clone https://github.com/cindykandie/awesome-books/.git
